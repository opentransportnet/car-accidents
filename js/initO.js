...
function visualize(data){	
		...
		/*SERVELITY*/
		var sev   = {data: data.sev,  domain: ['1','2','3'] ,  name: 'sev', type:'ordinal', label : "accident servelity"};	
		...
		var hours = {data: data.hours,  min:0, max:24, num_bins: 24, name: 'hours',type:'linear', label :"hour of the day"} ;
		...
		var roadtype = {data: data.road_type, domain: ['1','2','3','4','5','6','7','8','9'],  
		...
		var legend = new HeatMapLegend('legend', 'heatmap', 'colorbrush');
		/**
		 * Addin all charts
		 */		
